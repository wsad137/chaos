...
import chaos.weixin.common.ValidateSignature;
import chaos.weixin.event.EventType;
import chaos.weixin.event.MsgType;
import chaos.weixin.param.SignatureParam;
import chaos.weixin.request.WechatRequest;
import chaos.weixin.response.*;
import chaos.weixin.util.lang.JaxbParser;
import chaos.weixin.util.lang.StreamUtils;
...
//		this.request = request;
    ...
    protected void init(HttpServletRequest request, Config config) {
        this.request = request;
        this.config = config;
    }
...
//			this.wechatRequest = (WechatRequest)jaxbParser.toObj(xmlStr);
    ...
    private void dispatchMessage() {
        ...
        switch (msgType) {
            case event:
                ...
                break;
            case text:
                onText(wechatRequest.getContent());
                break;
            case image:
                onImage();
                break;
            ...
            case shortvideo:
                ...
                break;
            case location:
                onLocation(wechatRequest, wechatResponse);
                break;
            case link:
                onLink(wechatRequest, wechatResponse);
                break;
            default:
                onUnknown();
                break;
     ...
     * @param content
     */
    protected abstract void onText(String content);
     ...
     */
    protected abstract void onLocation(WechatRequest wechatRequest, WechatResponse wechatResponse);
     ...
     * @param wechatResponse
     */
    protected abstract void onLink(WechatRequest wechatRequest, WechatResponse wechatResponse);
     ...
     * 自定义分发
     */
    protected abstract void dispatchDiy();
}

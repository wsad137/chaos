...
import chaos.weixin.response.ArticleResponse;
import chaos.weixin.response.MusicResponse;
import chaos.weixin.response.VideoResponse;
...
public class CustomerMsg {
    ...
    private static final String MSG_URL = "https://api.weixin.qq.controller/cgi-bin/message/custom/send?access_token=";
    ...
    public CustomerMsg(Config config) {
        this.config = config;
    }
...
//	}
     ...
     */
    private void send() {
        String accessToken = TokenProxy.accessToken(config);

...
import chaos.weixin.oauth.protocol.refresh_access_token.RefreshAccessTokenRequest;
import chaos.weixin.oauth.protocol.refresh_access_token.RefreshAccessTokenResponse;
import chaos.weixin.oauth.protocol.valid_access_token.ValidAccessTokenRequest;
import chaos.weixin.oauth.protocol.valid_access_token.ValidAccessTokenResponse;
...
public class OAuthManager {
    ...
    private OAuthManager(Config config) {
        this.config = config;
    }

    private Config config;

    public static OAuthManager getInstance(Config config) {
...
//    /*生成OAuth重定向URI（用户同意授权，获取code）*/
//    private static final String HTTPS_OPEN_WEIXIN_QQ_COM_CONNECT_OAUTH2_AUTHORIZE = "https://open.weixin.qq.controller/connect/oauth2/authorize";
//    /*通过code换取网页授权access_token*/
//    private static final String HTTPS_API_WEIXIN_QQ_COM_SNS_OAUTH2_ACCESS_TOKEN = "https://api.weixin.qq.controller/sns/oauth2/access_token";
//    /*刷新access_token（如果需要）*/
//    private static final String HTTPS_API_WEIXIN_QQ_COM_SNS_OAUTH2_REFRESH_TOKEN = "https://api.weixin.qq.controller/sns/oauth2/refresh_token";
//    /*拉取用户信息(需scope为 snsapi_userinfo)*/
//    private static final String HTTPS_API_WEIXIN_QQ_COM_SNS_USERINFO = "https://api.weixin.qq.controller/sns/userinfo";
//    /*检验授权凭证（access_token）是否有效*/
//    private static final String HTTPS_API_WEIXIN_QQ_COM_SNS_AUTH = "https://api.weixin.qq.controller/sns/auth";
     ...
     * @return
     */
    public String generateRedirectURI(String redirectURI, String scope, String state) {
        StringBuffer url = new StringBuffer();
        url.append(HTTPS_OPEN_WEIXIN_QQ_COM_CONNECT_OAUTH2_AUTHORIZE);
        url.append("?appid=").append(urlEncode(config.getAppid()));

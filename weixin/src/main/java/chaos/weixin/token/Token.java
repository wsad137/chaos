...
public abstract class Token {
    ...
    // TODO: 2017/6/2 没使用
//    public String getToken(String publicNo) {
//        return this.token;
//    }
     ...
     */
    public boolean request(Config config) {
        String url = accessTokenUrl(config);
...
//    public boolean request(String publicNo) {
//        String url = accessTokenUrl(publicNo);
//        String result = HttpUtils.get(url);
//        if (StringUtils.isBlank(result))
//            return false;
//        if (!parseData(result)) {
...
//    }
     ...
     * @return
     */
    protected abstract String accessTokenUrl(Config config);
     ...
     * @return
     */
//    protected abstract String accessTokenUrl(String publicNo);

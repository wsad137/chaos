...
//    public UserManager(String publicNo) {
...
//    }
    ...
    public Follwers subscriberList(String nextOpenId) {
        String url = USRE_GET_URL + TokenProxy.accessToken(config);
    ...
    public void updateRemark(String openId, String remark) throws WeChatException {
        ...
        String resultStr = HttpUtils.post(USER_UPDATE_REMARK_POST_URL + TokenProxy.accessToken(config), requestData);
        logger.info("return data " + resultStr);
        WeChatUtil.isSuccess(resultStr);
    }
    ...
    public User getUserInfo(String openId, LanguageType lang) {
        String url = USER_INFO_GET_URL + TokenProxy.accessToken(config) + "&openid=" + openId;
        if (lang != null) {
            url += "&lang=" + lang.name();
        }
        String resultStr = HttpUtils.get(url);
    ...
    public Group createGroup(String name) throws WeChatException {
        ...
        logger.info("request data " + requestData);
        String resultStr = HttpUtils.post(GROUP_CREATE_POST_URL + TokenProxy.accessToken(config), requestData);
        logger.info("return data " + resultStr);
        WeChatUtil.isSuccess(resultStr);
    ...
    public List<Group> getGroup() {
        String resultStr = HttpUtils.post(GROUP_GET_POST_URL + TokenProxy.accessToken(config));
        logger.info("return data " + resultStr);
        try {
            WeChatUtil.isSuccess(resultStr);
        } catch (WeChatException e) {
    ...
    public Integer getIdGroup(String openId) {
        ...
        String requestData = jsonObject.toString();
        logger.info("request data " + requestData);
        String resultStr = HttpUtils.post(GROUP_GETID_POST_URL + TokenProxy.accessToken(config), requestData);
        logger.info("return data " + resultStr);
        try {
            WeChatUtil.isSuccess(resultStr);
        } catch (WeChatException e) {
    ...
    public void updateGroup(int groupId, String name) throws WeChatException {
        ...
        String requestData = groupJson.toString();
        logger.info("request data " + requestData);
        String resultStr = HttpUtils.post(GROUP_UPDATE_POST_URL + TokenProxy.accessToken(config), requestData);
        logger.info("return data " + resultStr);
        WeChatUtil.isSuccess(resultStr);
    }
    ...
    public void membersUpdateGroup(String openId, int groupId) throws WeChatException {
        ...
        String requestData = jsonObject.toString();
        logger.info("request data " + requestData);
        String resultStr = HttpUtils.post(GROUP_MEMBERS_UPDATE_POST_URL + TokenProxy.accessToken(config), requestData);
        logger.info("return data " + resultStr);
        WeChatUtil.isSuccess(resultStr);
    }
     ...
     * 批量移动用户分组
     *
     * @param groupId 用户唯一标识符openid的列表（size不能超过50）
     * @param openIds 分组id
     * @return 是否修改成功
     * @throws WeChatException
     */
    public void membersDatchUpdateGroup(String[] openIds, int groupId) throws WeChatException {
        ...
        String requestData = jsonObject.toString();
        logger.info("request data " + requestData);
        String resultStr = HttpUtils.post(GROUP_MEMBERS_DATCHUPDATE_POST_URL + TokenProxy.accessToken(config), requestData);
        logger.info("return data " + resultStr);
        WeChatUtil.isSuccess(resultStr);
    }
    ...
    public void deleteGroup(int groupId) throws WeChatException {
        ...
        logger.info("request data " + requestData);
        String resultStr = HttpUtils.post(GROUP_DELETE_POST_URL + TokenProxy.accessToken(config), requestData);
        logger.info("return data " + resultStr);
        WeChatUtil.isSuccess(resultStr);
    }
}

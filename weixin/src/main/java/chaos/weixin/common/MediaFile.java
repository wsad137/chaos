...
public class MediaFile {
    ...
    private static final String UPLOAD = "http://file.api.weixin.qq.controller/cgi-bin/media/upload?access_token=";
    private static final String DOWNLOAD = "http://file.api.weixin.qq.controller/cgi-bin/media/get?access_token=";
    ...
    public MediaFile(Config config) {
        this.config = config;
    }
    ...
    private String uploadUrl() {
        String url = UPLOAD + TokenProxy.accessToken(config) + "&"
    ...
    private String downloadUrl() {
        String url = DOWNLOAD + TokenProxy.accessToken(config) + "&"

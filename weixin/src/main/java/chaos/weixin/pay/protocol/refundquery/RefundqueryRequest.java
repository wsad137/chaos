package chaos.weixin.pay.protocol.refundquery;
...
public class RefundqueryRequest {
    ...
    private RefundqueryRequest(Config config) {
        this.config = config;
    }

    private Config config;

    public static RefundqueryRequest getInstance(Config config) {
        return new RefundqueryRequest(config);
    }

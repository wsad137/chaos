package chaos.weixin.pay.protocol.orderquery;
...
public class OrderqueryRequest {
    ...
    private OrderqueryRequest(Config config) {
        this.config = config;
    }

    private Config config;
    private String appid = this.config.getAppid();
    private String mch_id = this.config.getMchId();

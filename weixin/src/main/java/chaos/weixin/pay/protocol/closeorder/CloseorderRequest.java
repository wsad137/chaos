package chaos.weixin.pay.protocol.closeorder;
...
public class CloseorderRequest {
    ...
    private CloseorderRequest(Config config) {
        this.config = config;
    }

    private Config config;

    public static CloseorderRequest getInstance(Config config) {
        return new CloseorderRequest(config);
    }

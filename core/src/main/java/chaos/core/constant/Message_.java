...
public interface Message_ {
    ...
    interface account {
        String empty_username = "2401_用户名不能为空！";
        String notExist_acount = "2402_账号不存在！";
        String error_password = "2403_密码错误！";
        String exist_acount = "2404_账号已经存在！";
        String empty_password = "2405_密码不能为空！";
    }
